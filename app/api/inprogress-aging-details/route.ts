    ...
    const sql = `
      WITH base AS (
        SELECT DISTINCT
          ...
          -- Brand SLA span: PENDING -> INPROGRESS, Sundays excluded (IST).
          ...
          -- Pickup SLA span: INPROGRESS -> DISPATCHED, Sundays excluded (IST).
          ...
          (po."amount"::numeric + COALESCE(po."platformMarginDiscount", 0)::numeric + COALESCE(po."totalDiscount"::numeric, 0))::text         AS "poAmount",
