...
const COVERED_SELECT = `
  ...
  COALESCE(SUM((po."amount"::numeric + COALESCE(po."platformMarginDiscount", 0)::numeric + COALESCE(po."totalDiscount"::numeric, 0))) FILTER (WHERE b."pincode" IS NOT NULL AND b."pincode" <> ''), 0)::text AS pincode_amount,
  ...
  COALESCE(SUM((po."amount"::numeric + COALESCE(po."platformMarginDiscount", 0)::numeric + COALESCE(po."totalDiscount"::numeric, 0))) FILTER (WHERE b."city" IS NOT NULL AND b."city" <> ''), 0)::text AS city_amount,
  ...
  COALESCE(SUM((po."amount"::numeric + COALESCE(po."platformMarginDiscount", 0)::numeric + COALESCE(po."totalDiscount"::numeric, 0))) FILTER (WHERE b."district" IS NOT NULL AND b."district" <> ''), 0)::text AS district_amount,
  ...
  COALESCE(SUM((po."amount"::numeric + COALESCE(po."platformMarginDiscount", 0)::numeric + COALESCE(po."totalDiscount"::numeric, 0))) FILTER (WHERE b."state" IS NOT NULL AND b."state" <> ''), 0)::text AS state_amount
`;
