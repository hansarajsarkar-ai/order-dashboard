      ...
      <div className="w-[95%] mx-auto relative z-10">
        ...
        <div className="mb-6">
          ...
          <p className="text-purple-200 text-sm mt-1">
            Brand-level visibility — live vs inactive, GMV, coverage, and seller→brand catalog health.
          </p>
        </div>

        {/* Placeholder content card — replace with real charts/tables */}
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden">
          <div className="px-8 py-6 border-b border-white/10 bg-white/5">
            <h2 className="text-xl font-bold text-white">Coming together…</h2>
            <p className="text-purple-300 text-sm mt-1">
              This dashboard is scaffolded. Drop in the brand-performance widgets you want surfaced here.
            </p>
          </div>
          <div className="p-12 text-center">
            <div className="text-5xl mb-4">🏷️</div>
            <p className="text-purple-200 text-sm max-w-xl mx-auto">
              Suggested sections: Live brand mappings (from <code className="text-purple-100">seller_brand</code>),
              brand × state GMV breakdown, last-order recency, configured but idle brands,
              minimum order value / commission spread.
            </p>
          </div>
        </div>
      </div>
