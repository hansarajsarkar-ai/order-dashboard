      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-purple-200/80 text-sm mt-1">
            Calls made, connect rate, talk time, conversions per agent, and daily / weekly productivity trends.
          </p>
        </div>

        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-12 text-center">
          <div className="text-5xl mb-4">📞</div>
          <h2 className="text-2xl font-bold text-white mb-2">Coming together</h2>
          <p className="text-purple-300 mb-2">
            This dashboard is live but the metrics are still being wired up.
          </p>
          <p className="text-xs text-purple-300/60">
            Add cards, tables, and charts inside <code className="text-purple-200">app/badho/calling-team/page.tsx</code>.
          </p>
        </div>
      </div>
