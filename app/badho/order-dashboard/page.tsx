        ...
        {pivotDrillOpen && (
          ...
          >
            ...
            >
              ...
              <div className="relative px-4 py-2.5 border-b border-slate-200 bg-slate-50/80">
                <div className="flex flex-col md:flex-row md:items-end gap-2">
                  <div className="flex-1 min-w-0">
                    <label htmlFor="pivot-drill-search" className="block text-[11px] font-bold text-slate-600 uppercase tracking-wide mb-1">Search</label>
                    <div className="relative">
                      ...
                      {pivotDrillSearch && (
                        <button
                          ...
                          className="absolute right-2 top-1/2 -translate-y-1/2 h-5 w-5 inline-flex items-center justify-center rounded-full text-slate-400 hover:bg-slate-200 hover:text-slate-700"
                        >
                          ×
                        </button>
                      )}
                  ...
                  <div className="md:w-auto">
                    <span className="block text-[11px] font-bold text-slate-600 uppercase tracking-wide mb-1">Pushed</span>
                  ...
                  {pivotRejectReasonOptions.length > 0 && (
                    <div className="md:w-64">
                      <label htmlFor="pivot-drill-reject-reason" className="block text-[11px] font-bold text-slate-600 uppercase tracking-wide mb-1">
                ...
                {pivotDrillHasActiveFilters && (
                  <div className="mt-3 flex flex-wrap items-center gap-2">
                    <span className="text-[11px] uppercase tracking-wide text-slate-600 font-bold">Active</span>
                    {pivotDrillSearch.trim() !== '' && (
                      <button
                        type="button"
                        onClick={() => setPivotDrillSearch('')}
                        className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs border border-slate-300 font-medium"
                      >
