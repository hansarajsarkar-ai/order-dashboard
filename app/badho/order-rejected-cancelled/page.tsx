 ...
 * ─────────────────────────────────────────────────────────────────────
 *  Scaffolded from app/badho/_template. Replace the placeholder card
 *  below with the rejected/cancelled order analytics.
 * ─────────────────────────────────────────────────────────────────────
 */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* ─── Order Rejected / Cancelled content goes here ──────── */}
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-12 text-center">
          <div className="text-5xl mb-4">🚫</div>
          <h1 className="text-3xl font-bold text-white mb-2">Order Rejected / Cancelled</h1>
          <p className="text-purple-300">
            Rejected and cancelled order analytics — coming up here.
          </p>
        </div>
      </div>
