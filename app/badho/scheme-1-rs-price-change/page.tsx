    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-12 text-center">
          <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-fuchsia-500/40 to-purple-600/40 border border-fuchsia-400/30 flex items-center justify-center text-4xl shadow-[0_0_24px_rgba(217,70,239,0.3)]">
            📈
          </div>
          <h2 className="text-2xl font-bold text-white mb-2">Coming soon</h2>
          <p className="text-purple-300 max-w-md mx-auto">
            This dashboard is being built. It will surface price-change events, before/after pricing, affected SKUs, and downstream order/GMV impact for Scheme 1.
          </p>
        </div>
      </div>
